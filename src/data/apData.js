export const apData = {
  ...
  'U6-Lite': {
    ...
    radio24: { mimo: '2x2', txPower: 20, gain: 2.8, maxRate: 300 },
    radio5: { mimo: '2x2', txPower: 23, gain: 3, maxRate: 1201 },
    radio6: null, streams: 4, coverage: 111, clients: '300+',
  ...
  'U6+': {
    ...
    radio6: null, streams: 4, coverage: 130, clients: '300+',
    ethernet: '1 GbE', poe: 'PoE+ (15W)', mount: 'Ceiling/Wall',
  ...
  'U6-LR': {
    ...
    radio6: null, streams: 8, coverage: 172, clients: '350+',
    ethernet: '1 GbE', poe: 'PoE+ (20W)', mount: 'Ceiling/Wall',
  ...
  'U6-Pro': {
    ...
    radio6: null, streams: 6, coverage: 130, clients: '250+',
  ...
  'U6-Mesh-Pro': {
    ...
    radio24: { mimo: '2x2', txPower: 24, gain: 8, maxRate: 573 },
    radio5: { mimo: '2x2', txPower: 27, gain: 8, maxRate: 2400 },
    radio6: null, streams: 4, coverage: 172, clients: '250+',
    ethernet: '1 GbE + Passthrough', poe: 'PoE+ (15W)', mount: 'Pole/Wall',
    features: ['IP65', 'Mesh', 'High-Gain'], notes: 'Outdoor high-gain, 8 dBi per band',
  ...
  'U6-Mesh': {
    ...
    radio5: { mimo: '4x4', txPower: 23, gain: 5, maxRate: 4804 },
    radio6: null, streams: 6, coverage: 130, clients: '250+',
    ethernet: '1 GbE', poe: 'PoE+ (18W)', mount: 'Pole/Wall',
  ...
  'U6-IW': {
    ...
    radio24: { mimo: '2x2', txPower: 22, gain: 5, maxRate: 573 },
    radio5: { mimo: '4x4', txPower: 24, gain: 5.9, maxRate: 4800 },
    radio6: null, streams: 6, coverage: 107, clients: '250+',
  ...
  'U6-Extender': {
    ...
    color: '#F97316', msrp: 99, eur: 89, status: 'current',
    radio24: { mimo: '2x2', txPower: 20, gain: 5, maxRate: 573 },
    radio5: { mimo: '4x4', txPower: 24, gain: 6, maxRate: 4804 },
    radio6: null, streams: 6, coverage: 107, clients: '250+',
    ethernet: '1 GbE', poe: 'AC-Steckdose (11W)', mount: 'Wall outlet',
  ...
  'U6-Enterprise': {
    ...
    radio24: { mimo: '2x2', txPower: 23, gain: 3.2, maxRate: 573 },
    radio5: { mimo: '4x4', txPower: 26, gain: 5.3, maxRate: 4800 },
    radio6: { mimo: '4x4', txPower: 23, gain: 6, maxRate: 4800 },
    streams: 10, coverage: 140, clients: '600+',
    ethernet: '2.5 GbE', poe: 'PoE++ (22W)', mount: 'Ceiling/Wall',
  ...
  'U6-Enterprise-IW': {
    ...
    radio24: { mimo: '2x2', txPower: 22, gain: 4, maxRate: 573 },
    radio5: { mimo: '4x4', txPower: 25, gain: 5.8, maxRate: 4804 },
    radio6: { mimo: '4x4', txPower: 24, gain: 5.8, maxRate: 4804 },
    streams: 10, coverage: 130, clients: '600+',
  ...
  'U7-Pro-XG': {
    ...
    radio24: { mimo: '2x2', txPower: 23, gain: 4, maxRate: 688 },
    radio5: { mimo: '2x2', txPower: 26, gain: 5, maxRate: 4324 },
  ...
  'U7-IW': {
    ...
    radio5: { mimo: '2x2', txPower: 24, gain: 8, maxRate: 4324 },
    radio6: null, streams: 4, coverage: 115, clients: '200+',
  ...
  'U7-Pro-Wall': {
    ...
    radio24: { mimo: '2x2', txPower: 23, gain: 2.5, maxRate: 688 },
    radio5: { mimo: '2x2', txPower: 24, gain: 5, maxRate: 4324 },
    radio6: { mimo: '2x2', txPower: 23, gain: 6, maxRate: 5765 },
    streams: 6, coverage: 140, clients: '300+',
  ...
  'U7-Outdoor': {
    ...
    color: '#22C55E', msrp: 179, eur: 175, status: 'current',
    radio24: { mimo: '2x2', txPower: 25, gain: 4, maxRate: 688 },
    radio5: { mimo: '2x2', txPower: 28, gain: 12.5, maxRate: 4324 },
    radio6: null, streams: 4, coverage: 465, clients: '250+',
    ethernet: '2.5 GbE', poe: 'PoE+ (22W)', mount: 'Pole/Wall',
    features: ['IPX6', 'Directional'], notes: 'Directional super antenna (45°×45°) + ext. omni port',
    elevation: { '2.4GHz': [-1, 3.5, 4.5, 5, 4.5, 3.5, 2.3, 1, -0.5, -3.5], '5GHz': [-4, 9, 12, 12.5, 12, 9.5, 6, 2, -2, -7] },
    azimuth: { '2.4GHz': [5, 4.8, 4.9, 4.7, 5, 4.8, 4.9, 4.7, 5, 4.8, 4.9, 4.7], '5GHz': [12.5, 10, 6, 2, -2, -6, -2, 2, 6, 10, 12.5, 10] },
    beamwidth: { h: 45, v: 45 }
  },
  'U7-Pro-Outdoor': {
    name: 'U7-Pro-Outdoor', sku: 'U7-Pro-Outdoor', generation: 'Wi-Fi 7', category: 'outdoor',
    color: '#22C55E', msrp: 379, eur: 369, status: 'current',
    radio24: { mimo: '2x2', txPower: 25, gain: 8, maxRate: 688 },
    radio5: { mimo: '2x2', txPower: 28, gain: 11, maxRate: 4324 },
    radio6: { mimo: '2x2', txPower: 30, gain: 10, maxRate: 5765 },
    streams: 6, coverage: 465, clients: '500+',
    ethernet: '2.5 GbE', poe: 'PoE+ (22W)', mount: 'Pole/Wall',
    features: ['6 GHz', 'AFC', 'IP67', 'Directional'], notes: 'Directional (90°×45°) + 360° omni antenna',
    elevation: { '2.4GHz': [-1, 5, 7, 8, 7, 5.5, 3, 1, -1, -5], '5GHz': [-3, 7, 10, 11, 10, 7.5, 4.5, 1, -2, -7], '6GHz': [-3, 6.5, 9.3, 10, 9.3, 7, 4, 1, -2, -7] },
    azimuth: { '2.4GHz': [8, 7.5, 6.5, 4, 0, -4, 0, 4, 6.5, 7.5, 8, 7.5], '5GHz': [11, 10, 8, 4, 0, -4, 0, 4, 8, 10, 11, 10], '6GHz': [10, 9, 7.5, 3.5, 0, -4, 0, 3.5, 7.5, 9, 10, 9] },
    beamwidth: { h: 90, v: 45 }
  },
  // Enterprise E7
  'E7': {
