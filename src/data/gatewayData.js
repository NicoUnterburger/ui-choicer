export const gatewayData = {
  ...
  'EFG': { name: 'Enterprise Fortress Gateway', sku: 'EFG', category: 'enterprise', color: '#DC2626', msrp: 1999, status: 'current',
    ...
    cpu: '18-core ARM @ 2.0 GHz', ram: 16,
  ...
  'UCG-Industrial': { name: 'Cloud Gateway Industrial', sku: 'UCG-Industrial', category: 'special', color: '#F59E0B', msrp: 579, status: 'new',
    ipsSpeed: 5, devices: 50, clients: 500, wan: '10G SFP+ / 10G RJ45 / 2.5G RJ45', lan: '4x 2.5GbE + 10G RJ45', sfp: '1x 10G SFP+',
    wifi: 'Wi-Fi 7 (Dual-band)', poe: '5x PoE (350W)', storage: '128GB microSD', formFactor: 'Desktop', power: 300,
    cpu: '4-core A73 @ 2.2 GHz', ram: 3,
    features: ['Wi-Fi 7', '10G', 'PoE+++', 'Industrial', 'Fanless', '-30°C..50°C'], apps: ['Network', 'Protect', 'Talk', 'Access'], notes: 'Ruggedized industrial gateway, -30 to 50°C' },
};
