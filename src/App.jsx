          ...
          <>
            ...
            <div className="bg-gray-800 rounded-lg p-3 mb-2">
              ...
              <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-2 mt-3">
                ...
                <div className="bg-gray-700/50 rounded p-2">
                  <h4 className="text-xs font-semibold text-rose-400 mb-1">CPU</h4>
                  <div className="text-xs">{gw.cpu}</div>
                </div>
                <div className="bg-gray-700/50 rounded p-2">
                  <h4 className="text-xs font-semibold text-rose-400 mb-1">RAM</h4>
                  <div className="text-xs">{gw.ram} GB</div>
                </div>
              </div>
                  ...
                  <tbody>
                    {filteredGateways.map(([k, g]) => (
                      <tr key={k} className={`border-b border-gray-700 hover:bg-gray-700 cursor-pointer ${selectedGateway === k ? 'bg-gray-700' : ''}`} onClick={() => setSelectedGateway(k)}>
                        ...
                        <td className="p-1 text-center text-xs">{g.cpu}</td>
                        <td className="p-1 text-center text-rose-400">{g.ram} GB</td>
